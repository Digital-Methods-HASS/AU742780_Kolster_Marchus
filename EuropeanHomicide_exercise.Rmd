...
Western_Europe_plotting %>%
  ...
  geom_smooth() +
  geom_jitter() +
  labs(title="HomicideDevelopment") +
...
From what we can see from the plots, it's clear that homicides has declined over the past years. Although, England and Germany has taken a smaller decline, it is still clear that we today are more civilized than before. 